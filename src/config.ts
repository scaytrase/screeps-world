...
export const HARVESTER_BODY = WORKER_CREEP_BODY_LVL2;
...
export const BUILDERS_COUNT_LIMIT = 3;
export const BUILDER_BODY = WORKER_CREEP_BODY_LVL2;

export const UPGRADERS_COUNT_LIMIT = 6;
...
export const GRAVE_KEEPER_BODY = BASE_CARRIER_CREEP_BODY;
...
export const LINK_KEEPER_BODY = BASE_CARRIER_CREEP_BODY;
