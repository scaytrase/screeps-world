...
export const HARVESTER_BODY = BASE_WORKER_CREEP_BODY;

export const MINERS_COUNT_LIMIT = 0;
export const MINER_BODY = BASE_WORKER_CREEP_BODY;
...
export const BUILDERS_COUNT_LIMIT = 1;
export const BUILDER_BODY = BASE_WORKER_CREEP_BODY;

export const UPGRADERS_COUNT_LIMIT = 1;
export const UPGRADER_BODY = BASE_WORKER_CREEP_BODY;

export const REPAIRERS_COUNT_LIMIT = 1;
export const REPAIRER_BODY = BASE_WORKER_CREEP_BODY;
...
export const SPAWN_KEEPERS_COUNT_LIMIT = 0;
...
export const GRAVE_KEEPERS_COUNT_LIMIT = 0;
...
export const ENERGY_AGGREGATOR_BODY = BASE_CARRIER_CREEP_BODY;

export const LINK_KEEPERS_COUNT_LIMIT = 0;
